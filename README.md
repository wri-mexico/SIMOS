...
El Sistema de Movilidad Integrado (SIMOS) es una aplicación de software libre (Open Source) potenciada por el core de [MxSIG](http://simos.col.gob.mx/mxsig){:target="_blank"} (consulta el repositorio [aquí](https://github.com/MxSIG/mxsig){:target="_blank"}), una plataforma de código abierto para la web desarrollada para implementar soluciones geomáticas que facilitan el uso, integración, interpretación, publicación y análisis de la información geográfica y estadística.
